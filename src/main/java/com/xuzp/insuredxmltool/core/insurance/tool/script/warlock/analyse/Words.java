package com.xuzp.insuredxmltool.core.insurance.tool.script.warlock.analyse;
...
public class Words {
    ...
    public int getLocation(int index) {
        return (Integer) locationList.get(index);
    }
    ...
    public void add(String word, int type, int loc) {
        ...
        locationList.add(new Integer(loc));
    }
    ...
    public int getType(int index) {
        return (Integer) typeList.get(index);
    }
