...
import com.xuzp.insuredxmltool.core.insurance.tool.script.warlock.function.*;
...
public class ArithmeticFunction extends CodeImpl
{
	...
	static
	{
		...
		Script.FUNCTIONS.put("pmt",new FunctionPMT());
		Script.FUNCTIONS.put("tccat",new FunctionTCCAT());
	}
