 ...
 *
 */
package com.xuzp.insuredxmltool.core.insurance.tool.script;
...
import com.xuzp.insuredxmltool.core.insurance.tool.script.warlock.Interrupt;
...
public class Script extends CodeImpl
{
	...
	public Object run(Factors factors)
	{
		...
		Stack stack = factors instanceof java.util.Stack ? (Stack)factors : new Stack(factors);
